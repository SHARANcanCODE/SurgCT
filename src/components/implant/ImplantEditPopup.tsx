...
export function ImplantEditPopup({ implantId, onClose }: ImplantEditPopupProps) {
  ...
  return (
    <>
      ...
      <div className="fixed left-[20rem] top-24 z-50 w-64 bg-white border border-gray-300 dark:bg-gray-800 dark:border-gray-600 rounded-none shadow-xl p-3 space-y-3">
        <div className="flex items-center justify-between">
          <span className="text-sm font-bold text-dental-600 dark:text-dental-400 select-none">{implant.name}</span>
          <button
            onClick={onClose}
            className="w-6 h-6 flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-gray-200 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 rounded-none"
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="flex-1 bg-gray-100 text-gray-700 border-gray-300 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 text-xs rounded-none px-1 py-1 border"
          >
        ...
        <div>
          ...
          <div className="flex gap-1 mt-1">
            <button
              ...
              className="flex-1 px-1 py-0.5 text-[10px] bg-gray-200 text-gray-700 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 rounded-none"
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-2 space-y-2">
          <label className="flex items-center justify-between cursor-pointer select-none">
            ...
            <input
              ...
              className="accent-dental-500 rounded-none"
            />
          </label>
