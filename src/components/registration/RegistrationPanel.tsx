...
export function RegistrationPanel() {
  ...
  if (!reg || !scan) {
    ...
    return (
      <div className="absolute top-2 left-12 z-40 w-64 bg-white border border-gray-300 dark:bg-gray-800 dark:border-gray-600 rounded-none shadow-xl p-3 space-y-1">
  ...
  const pickBtn = (slot: number, kind: 'scan' | 'cbct', set: boolean) => {
    ...
    return (
      <button
        ...
        className={`
          flex-1 px-1.5 py-1 text-[11px] rounded-none transition-colors border
          ${active
  ...
  return (
    <div className="absolute top-2 left-12 z-40 w-64 bg-white border border-gray-300 dark:bg-gray-800 dark:border-gray-600 rounded-none shadow-xl p-3 space-y-2">
      <div className="flex items-center justify-between">
      ...
      <button
        ...
        disabled={!complete}
        className={`
          w-full px-2 py-1.5 text-xs rounded-none transition-colors
          ${complete
