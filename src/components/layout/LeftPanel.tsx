...
function ToolButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      title={title}
      className={`flex items-center gap-1.5 px-2 py-1.5 text-xs rounded-none border transition-colors ${
        disabled
    ...
    <div className="flex h-full shrink-0">
      ...
      >
        <div className="w-72 h-full overflow-y-auto p-3 space-y-3">
          {/* Tools */}
          {toolsOpen && (
          <div className="space-y-2 rounded-none border border-slate-200 dark:border-slate-700/60 p-2">
            ...
            {state.layoutMode === 'OPG2+1' && (
              <div className="grid grid-cols-2 gap-1 pt-1">
                <button
                  ...
                  className={`px-2 py-1 text-[11px] rounded-none border transition-colors ${
                ...
                <button
                  ...
                  className={`px-2 py-1 text-[11px] rounded-none border transition-colors ${
                    state.anatomyDrawMode === 'nerve' ? 'border-dental-500 bg-dental-600 text-white'
                      : 'border-slate-200 dark:border-slate-700/60 bg-slate-100/60 dark:bg-slate-800/60 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
                  }`}
                >
                  {t('anatomy.nerve')}
          ...
          <div className="space-y-2 rounded-none border border-slate-200 dark:border-slate-700/60 p-2">
            ...
            <div className="grid grid-cols-2 gap-1">
              <button
                ...
                className={`flex items-center justify-center gap-1 px-2 py-1.5 text-[11px] rounded-none border transition-colors ${
        ...
        <div className="w-56 h-full overflow-y-auto">
          {patientOpen && (
            <div className="p-2">
              ...
              <div className="rounded-none border border-slate-200 dark:border-slate-700/60 p-2.5">
                <PatientContent />
              </div>
            </div>
          )}
