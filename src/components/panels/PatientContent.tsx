...
const FIELD =
  'w-full bg-slate-100 text-slate-800 border-slate-300 dark:bg-slate-800 dark:text-slate-200 dark:border-slate-600 text-xs rounded-none px-2 py-1.5 border outline-none focus:border-white';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        {study ? (
          <div className="space-y-1.5 rounded-none border border-slate-200 dark:border-slate-700/60 p-2.5">
