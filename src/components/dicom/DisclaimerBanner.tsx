...
export function DisclaimerBanner() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-4xl m-3 rounded-none border border-amber-300 dark:border-amber-700/60 bg-white dark:bg-gray-800 shadow-2xl p-4 flex flex-col sm:flex-row sm:items-center gap-3">
        ...
        <button
          onClick={accept}
          className="shrink-0 self-end sm:self-auto px-5 py-2 rounded-none bg-dental-600 text-white text-sm font-semibold hover:bg-dental-700 transition-colors"
        >
          {t('disclaimer.agree')}
        </button>
      </div>
