...
export interface ViewerState {
  ...
  activePanel: 'layers' | 'settings' | 'help' | 'patients' | 'intro' | 'ai' | null;
...
export type ViewerAction =
  ...
  | { type: 'SET_ACTIVE_PANEL'; payload: 'layers' | 'settings' | 'help' | 'patients' | 'intro' | 'ai' | null }
  | { type: 'TOGGLE_PANEL'; payload: 'layers' | 'settings' | 'help' | 'patients' | 'intro' | 'ai' }
  | { type: 'TOGGLE_PATIENT' }
  | { type: 'TOGGLE_TOOLS' }
  | { type: 'TOGGLE_LAYERS' }
  | { type: 'TOGGLE_SERIES' }
