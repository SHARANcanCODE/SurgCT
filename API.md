# SURGCT — API reference

`surgct` ([SURGCT](README.md)) is an embeddable React surgical dental CBCT / CT
viewer, guided implant planner, and AI diagnostic system. This document is the complete public API: the
`<DicomViewer>` component, its imperative ref, and the framework-free `/core`
subpath.

- **Package:** `surgct` · **License:** MIT
